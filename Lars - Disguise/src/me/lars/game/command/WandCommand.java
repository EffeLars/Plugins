...
public class WandCommand implements CommandExecutor {
	public ItemStack EmpireWand1 = new ItemStack(Material.BLAZE_ROD);
	public ItemMeta EmpireWand1Meta = EmpireWand1.getItemMeta();
	@Override
	public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
		...
		if (cmd.getName().equalsIgnoreCase("disguise")) {
			...
			if (args.length >= 1 && args[0].equalsIgnoreCase("Lars")) {
